...
Fer fer aquesta anàlisi s'ha utilitzat R v3.6.3 (2020-02-29) amb Bioconductor v3.10. Els paquets utilitzats inclouen:
...
El procediment detallat amb tot el codi de R utilitzat, juntament amb l'*output* dels fragments de codi, es pot trobar a l'arxiu "pipeline.pdf" al repositori de GitHub, generat a partir de l'arxiu de markdown "pipeline.Rmd". El codi pressuposa tenir instal·lats els paquets necessaris.
